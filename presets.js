...
exports.getPresets = function (instance) {
  ...
  presets["Navigation_NextFS"] = getPresetForPresentationControl(
    "Next in full screen",
    "Next",
    "Navigation_NextFS",
    { SlideNumber: 1, Fullscreen: true }
  ...
  presets["Key_Left"] = getPresetForPresentationControl(
    "Simulate left arrow keystroke",
    "<",
    "Keystroke",
    { Key: "Key_Left" }
  );
  presets["Key_Right"] = getPresetForPresentationControl(
    "Simulate right arrow keystroke",
    ">",
    "Keystroke",
    { Key: "Key_Right" }
  );
  presets["Key_Esc"] = getPresetForPresentationControl(
    "Simulate Esc keystroke",
    "Esc",
    "Keystroke",
    { Key: "Key_Esc" }
  );
  presets["Key_B"] = getPresetForPresentationControl(
    "Simulate B keystroke",
    "B",
    "Keystroke",
    { Key: "Key_B" }
  );
...
function getPresetForStillImageDisplay(
  lbl,
  txt,
  key,
  clr1,
...
function getPresetforSlotPresentation(
  instanceLabel,
  lbl,
  txt,
  i,
